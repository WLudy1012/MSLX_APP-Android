...
/** POST /api/plugins/pair/codes 请求体（生成一次性配对码）。 */
...
/** POST /api/plugins/pair/codes 的 data 字段。 */
...
/** POST /api/plugins/pair/redeem 请求体（兑换二维码载荷）。 */
...
/** POST /api/plugins/pair/redeem 的 data 字段（完整 API Key 仅此一次返回）。 */
